<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EmailD.aspx.vb" Inherits="SIB.EmailD" %>
			...
			<div id="Menu" class="style1" style="MARGIN-LEFT: 50px">
				...
				<div>
					<table class="style1" id="table1" style="MARGIN-LEFT: 50px">
						<tr>
							<td class="style70">
                                <asp:Image ID="Image5" runat="server" Height="300px" ImageUrl="Menu/ezgif.com-optimize.gif" 
                                    Width="1148px" />
                            </td>
							<td class="style70">
								</td>
